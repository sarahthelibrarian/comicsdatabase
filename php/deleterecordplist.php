...
echo  "<center><h3>Delete Pull List Record </h3></center></h3><br><br>";
echo "       <nav>
        <ul class = 'nav'>
...
$sql2 = "DELETE FROM pull_comics WHERE pull_list_num = $dID";

if ($con->query($sql2) === TRUE)
    {
         echo "Records deleted successfully from Pull Comics";
     }
else {
      echo "Error deleting record: " . $con->error;
     }

$sql = "DELETE FROM pull_customers WHERE  pull_list_num = $dID";
if ($con->query($sql) === TRUE)
    {
         echo "Record deleted successfully from Pull List Customers<br><br>";
     }
else {
      echo "Error deleting record: " . $con->error;
     }
