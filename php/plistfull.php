...
//this document gives a pull list customer's full purchase history, after searching them. it separates an option between if you query and get 1 result, 0 results, and more than 1
...
if ( $row['count'] > 1 )
{
  ...
  $sql = "select pull_customers.pull_list_num, pull_customers.pull_fname, pull_customers.pull_fname, pull_customers.pull_email, pull_customers.pull_phone
  from pull_customers
  where pull_customers.pull_lname = '$dlastname' and pull_customers.pull_fname = '$dfirstname'";
  ...
  echo "<p> Try searching again using the Pull List Number</p>";
