...
where '$dlastname' = freq_custlname and '$dfirstname' = freq_custfname and frequent_customer.freq_cust_ID = $dID and frequent_customer.freq_cust_ID = frequent_orders.freq_cust_ID;";
...
if ( $row == 0 )
{
  ...
  where  frequent_customer.freq_custlname = '$dlastname' and frequent_customer.freq_custfname = '$dfirstname' and frequent_customer.freq_cust_ID = $dID;";
  ...
  $dfirstname = $_POST['freqfname'];
  $dID = $_POST['freqcustID'];
  $sql = "select frequent_customer.freq_cust_ID, frequent_customer.freq_custlname, frequent_customer.freq_custfname,frequent_orders.freq_booktitle, frequent_orders.freq_cost,
  frequent_customer.lastcreditdate
    from frequent_orders
    inner join frequent_customer
    where  frequent_customer.freq_custlname = '$dlastname' and frequent_customer.freq_custfname = '$dfirstname' and frequent_customer.freq_cust_ID = $dID and frequent_customer.freq_cust_ID = frequent_orders.freq_cust_ID;";
