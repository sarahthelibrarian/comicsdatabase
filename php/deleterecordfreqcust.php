...
// this document deletes a frequent record
$con = mysqli_connect($host,$user,$password,$database)
     ...
     echo  "<center><h3>Delete Frequent CustomerRecord</h3></center></h3><br><br>";
     echo "       <nav>
             <ul class = 'nav'>
...
$sql2 = "DELETE FROM frequent_orders WHERE freq_cust_ID = $dID";

if ($con->query($sql2) === TRUE)
    {
         echo "Records deleted successfully from Frequent Orders";
     }
else {
...
$sql = "DELETE FROM frequent_customer WHERE freq_cust_ID = $dID";



if ($con->query($sql) === TRUE)
    {
         echo "Record deleted successfully from Frequent Customers <br><br>";
     }
else {
      echo "Error deleting record: " . $con->error;
     }
