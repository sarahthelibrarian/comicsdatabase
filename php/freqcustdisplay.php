...
// this document shows all of the frequent customer records
echo "<html>
          <head>
...
echo  "<center><h3>All Frequent Customer Data</h3></center></h3><br><br>";
echo "       <nav>
        <ul class = 'nav'>
...
echo "<h3> Go to a specific Record here </h3>";
...
echo "<h3>Delete Records Here</h3>
